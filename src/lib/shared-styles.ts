...
export const SHARED_STYLES = {
	...
	headerDropdownTrigger:
		'inline-flex items-center gap-2 border-b border-gray-300/70 dark:border-gray-600/70 px-1 pb-0.5 text-[28px] font-bold tracking-[4px] leading-none transition-colors duration-200 text-gray-800 dark:text-gray-100 hover:text-primary-800 dark:hover:text-primary-300',
