/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a8218e2a0c155f9df1a9095fac98d1ac)
// Runtime types generated with workerd@1.20260421.1 2025-12-11 nodejs_als,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		ASSETS: Fetcher;
		BODY_SIZE_CM: string;
		DEV_RSS_FEEDS: string;
		DEV_PORTFOLIO: string;
		DEV_SCALE_RESULTS: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "BODY_SIZE_CM" | "DEV_RSS_FEEDS" | "DEV_PORTFOLIO" | "DEV_SCALE_RESULTS">> {}
}
