/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 5e82b7bdc39cd0f3ddf3e0de85cb1020)
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MY_DOMAIN">> {}
}
