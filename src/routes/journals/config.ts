// Feed optimization configuration for journals
export const JOURNALS_CONFIG = {
	// Cache settings
...
export function getOptimizedConfig() {
	...
	return {
		...
		CACHE_DURATION: isProd ? JOURNALS_CONFIG.CACHE_DURATION : JOURNALS_CONFIG.CACHE_DURATION / 3,
		// More aggressive batching in production
		BATCH_SIZE: isProd ? JOURNALS_CONFIG.BATCH_SIZE : 2
	};
}
