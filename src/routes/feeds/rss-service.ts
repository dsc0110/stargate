...
// Common RSS configuration that can be overridden
...
// Common feed interfaces
export interface FeedConfig {
	name: string;
	url: string;
	category?: string; // Optional for blogs/journals
}
...
export interface FeedResponse {
	success: boolean;
	feeds?: FeedData[];
	availableCategories?: string[]; // Only for news
	error?: string;
	cacheInfo?: {
		timestamp: number;
